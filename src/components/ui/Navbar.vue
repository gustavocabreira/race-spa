  ...
  <nav class="bg-white shadow">
    <div class="container mx-auto px-4 py-4">
      <div class="flex items-center justify-between px-4">
        ...
        <div class="hidden sm:flex sm:items-center">
          <PrimaryButton @click="logout">Sair</PrimaryButton>
        </div>
...
export default defineComponent({
  ...
  data() {
    return {
      accessibleMenuItems: [
        ...
        {
          routeName: 'CreateDriver',
          label: 'Cadastrar Piloto',
        },
        {
          routeName: 'CreateRace',
          label: 'Cadastrar Corrida',
        },
        {
          routeName: 'CreateLap',
          label: 'Cadastrar Voltas',
        }
      ]
    }
  },
  methods: {
    logout() {
      client.post('auth/logout').then(response => {
        this.$router.push({
          name: 'LoginPage'
        })
      })
